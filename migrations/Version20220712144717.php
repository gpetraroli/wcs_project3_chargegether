 ...
 */
final class Version20220712144717 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking CHANGE user_id booking_user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_E00CEDDEFDD096B5 ON booking');
        $this->addSql('ALTER TABLE booking CHANGE booking_user_id user_id INT DEFAULT NULL');
